...
export interface ReceivablesUpdatePayIdStatusResponseV1 {
...
export const receivablesUpdatePayIdStatusResponseV1Schema: Schema<ReceivablesUpdatePayIdStatusResponseV1> = object(
  {
